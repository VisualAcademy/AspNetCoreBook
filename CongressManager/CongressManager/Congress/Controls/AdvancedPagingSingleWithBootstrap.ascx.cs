...
namespace CongressManager.Congress.Controls
{
    public partial class AdvancedPagingSingleWithBootstrap : System.Web.UI.UserControl
    {
        ...
        public string SearchField { get; set; } // 검색 필드: Name(UserId), Title, Content...
        ...
        /// <summary>
        /// 총 몇 개의 페이지가 만들어지는지: 총 레코드 수 / PageSize(10)(한페이지에서 보여줄)
        /// </summary>
        [Category("페이징처리")]
        ...
        /// </summary>
        [Category("페이징처리")]
        [Description("한 페이지에 몇 개의 레코드를 보여줄건지 결정")]
