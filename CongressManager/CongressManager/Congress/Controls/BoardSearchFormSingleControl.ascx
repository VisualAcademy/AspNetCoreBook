<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BoardSearchFormSingleControl.ascx.cs" Inherits="CongressManager.Congress.Controls.BoardSearchFormSingleControl" %>
...
<div style="text-align:center;">
    <a href="/Congress/CongressList.aspx" class="btn btn-success">검색 완료</a>
</div>
<% } %>
