<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BoardCommentControl.ascx.cs" Inherits="CongressManager.Congress.Controls.BoardCommentControl" %>
<%--<h3>댓글 리스트</h3>--%>
    ...
    <ItemTemplate>
        <tr style="border-bottom: 1px dotted silver;">
            ...
            <td style="width: 10px; text-align: center;">
                <a href=
                    'CongressCommentDelete.aspx?ArticleId=<%= Request["Id"] %>&Id=<%# Eval("Id") %>' title="댓글 삭제">
