<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BoardEditorFormControl.ascx.cs" Inherits="CongressManager.Congress.Controls.BoardEditorFormControl" %>
<style>
...
<table style="width:700px; border-collapse: collapse; 
    ...
    <% if (!String.IsNullOrEmpty(Request.QueryString["Id"]) && 
            FormType == Hawaso.Standard.BoardWriteFormType.Modify) { %>    
    <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:Image ID="imgSecurityImageText" runat="server" 
                ImageUrl="~/Congress/ImageText.aspx" />
    ...
    <tr>
        <td colspan="2" style="text-align:center;">
            ...
            <a href="CongressList.aspx" class="btn btn-default">리스트</a>
            <br />
