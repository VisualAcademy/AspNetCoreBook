<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="CongressView.aspx.cs" Inherits="CongressManager.Congress.CongressView" %>

<%@ Register Src="~/Congress/Controls/BoardCommentControl.ascx" TagPrefix="uc1" TagName="BoardCommentControl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="text-align: center;">
        ...
        <asp:HyperLink ID="lnkList" runat="server" NavigateUrl="CongressList.aspx" CssClass="btn btn-default">리스트</asp:HyperLink>
    </div>
