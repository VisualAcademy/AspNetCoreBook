...
{
    public partial class CongressList : Page
    {
        // 공통 속성: 검색 모드: 검색 모드이면 true, 그렇지 않으면 false.
        // [참고] 이러한 공통 속성들은 Base 클래스에 모아 넣고 상속해서 사용 권장
        ...
        private void DisplayData()
        {
            ...
            {
                ctlBoardList.DataSource = _repository.GetSeachAll(PageIndex, SearchField, SearchQuery);
            }
