<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChatRoomMulti.aspx.cs" Inherits="MemoEngine.ChatRoomMulti" %>
        ...
        function registerEvents(chat) {
            ...
            $('#btnSendMsg').click(function () {
                ...
                if (msg.length > 0) {
                    ...
                    chat.server.sendMessageToAll('<%= Request["BoardName"] %>', userName, msg);
                    $("#txtMessage").val('');
                }
            });
