...
{
    public partial class ScheduleByDomainWriteControl : System.Web.UI.UserControl
    {
        ...
        {
            (new DatabaseProviderFactory()).Create("ConnectionString").ExecuteNonQuery("AddScheduleByDomain", Session["UserID"].ToString(), lstYear.SelectedValue, ddlMonth.Items[ddlMonth.SelectedIndex].Value, comDay.SelectedValue, ctlHour.SelectedItem.Value, txtTitle.Text, txtContent.Text);
