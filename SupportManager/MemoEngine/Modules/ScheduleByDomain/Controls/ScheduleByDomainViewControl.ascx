<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleByDomainViewControl.ascx.cs" Inherits="DotNetNote.Modules.ScheduleByDomain.Controls.ScheduleByDomainViewControl" %>
