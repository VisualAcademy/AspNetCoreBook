<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleByDomainWriteControl.ascx.cs" Inherits="DotNetNote.Modules.ScheduleByDomain.Controls.ScheduleByDomainWriteControl" %>
