<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleByDomainListControl.ascx.cs" Inherits="DotNetNote.Modules.ScheduleByDomain.Controls.ScheduleByDomainListControl" %>
