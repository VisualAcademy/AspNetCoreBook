...
{
    public partial class ScheduleByCommunityWriteControl : System.Web.UI.UserControl
    {
        ...
        {
            (new DatabaseProviderFactory()).Create("ConnectionString").ExecuteNonQuery("AddScheduleByCommunity", Session["Community"].ToString(), lstYear.SelectedValue, ddlMonth.Items[ddlMonth.SelectedIndex].Value, comDay.SelectedValue, ctlHour.SelectedItem.Value, txtTitle.Text, txtContent.Text);
