<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleByCommunityViewControl.ascx.cs" Inherits="DotNetNote.Modules.ScheduleByCommunity.Controls.ScheduleByCommunityViewControl" %>
