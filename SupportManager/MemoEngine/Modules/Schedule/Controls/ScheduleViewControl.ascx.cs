...
{
    public partial class ScheduleViewControl : System.Web.UI.UserControl
    {
        ...
        private void DisplayData()
        {
            ...
            #region 제목과 내용 출력
            using (IDataReader objDr = (new DatabaseProviderFactory()).Create("ConnectionString").ExecuteReader("ViewSchedule", Request["Num"]))
            {
                if (objDr.Read())
                {
        ...
        {
            (new DatabaseProviderFactory()).Create("ConnectionString").ExecuteNonQuery("ModifySchedule", this.lstYear.SelectedValue, this.ddlMonth.SelectedValue, this.comDay.SelectedValue, this.ctlHour.SelectedValue, txtTitle.Text, txtContent.Text, Request["Num"]);
            btnList_Click(null, null);
        }
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            (new DatabaseProviderFactory()).Create("ConnectionString").ExecuteNonQuery("DeleteSchedule", Request["Num"]);
            btnList_Click(null, null);
        }
