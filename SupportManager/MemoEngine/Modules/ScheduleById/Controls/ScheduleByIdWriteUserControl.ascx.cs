...
{
    public partial class ScheduleByIdWriteUserControl : System.Web.UI.UserControl
    {
        ...
        private int _ParentId; // 넘겨져 온 Id 값 저장, 기본값은 -1
        #endregion
        ...
        private void DisplayData()
        {
            ...
            for (int i = 0; i <= 59; i++)
            {
                ListItem li = new ListItem(String.Format("{0}분", i), i.ToString());
                this.ctlMinute.Items.Add(li);
            }
            #endregion
        ...
        {
            (new DatabaseProviderFactory()).Create("ConnectionString").ExecuteNonQuery("AddScheduleById", txtCategoryName.SelectedValue, lstYear.SelectedValue, ddlMonth.Items[ddlMonth.SelectedIndex].Value, comDay.SelectedValue, ctlHour.SelectedItem.Value, txtTitle.Text, txtContent.Text, ctlMinute.SelectedValue, ctlIcon.SelectedValue, _ParentId);
        ...
        private void BindingCategories()
        {
            ...
            {
                txtCategoryName.Items.Add(names[i]);
            }
        }
    }
}